...
class RootActivity : DaggerAppCompatActivity() {
    ...
    private fun obtainViewModel(): CurlViewModel = ViewModelProviders.of(this, viewModelFactory).get(CurlViewModel::class.java)
    private fun obtainViewModel1(): HomeViewModel = ViewModelProviders.of(this, viewModelFactory).get(HomeViewModel::class.java)
